...
const StadiumDetail = () => {
  ...
  const pintPrices = reviews.map(r => r.pint_price).filter((p): p is number => p != null).map(Number).filter(n => !isNaN(n));
              ...
              {avgs ? (
                <div className="stat-card flex items-center gap-5">
                  ...
                  <div className="flex-1 space-y-1">
                    <p className="text-[10px] font-extrabold uppercase tracking-widest text-muted-foreground">Away Day Grade</p>
